...
import location from "../images/eventLocation.jpg";
          ...
          <div className="col-lg-8      overflow-hidden">
            ...
            <div className="row justify-content-end mt-5 mb-5">
              ...
              <div className="col-md-6 location ">
                ...
                <button className="shop rounded-pill mt-3">JOIN NOW</button>
              </div>
            </div>
                ...
                >
                  {event.gallery.map((g) => {
                    return (
                      <a
                        href={g}
                        className="imgSlide d-inline-block me-3"
                        data-lg-size="1600-2400"
                        onClick={(e) => {
                          e.preventDefault();
                        }}
                        style={{ width: "236px", height: "206px" }}
                        key={g}
                      >
                        <img src={g} alt="" className="w-100 h-100"></img>
                      </a>
                    );
                  })}
                </LightGallery>
