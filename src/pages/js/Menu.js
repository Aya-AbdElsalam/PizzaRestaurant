...
import SideNavBar from "../../component/js/SideNavBar";
            ...
            <div className="top row mb-5  pb-4 justify-content-between">
              ...
              <div className="dropdown col-sm   ">
                ...
                <ul className="dropdown-menu fw-bold">
                  <li id="high">
                    <Link
                      aria-label="sort items from hight to low price"
                  ...
                  <li id="low">
                    <Link
                      aria-label="sort items from low to height price"
                      className="dropdown-item"
                      onClick={() => {
