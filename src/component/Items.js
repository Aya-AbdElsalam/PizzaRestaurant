...
export default function Items(props) {
  ...
  function popUp(p) {
    setDetais([{ ...p }]);
    document.querySelector(".popUpItem").classList.add("open");
  }
  ...
  return (
    <>
      {/* card details */}
      <div className="popUpItem  w-100 h-100  justify-content-center align-items-center position-fixed d-none fixed-top fixed-left">
        ...
        <div className="card pop  mb-3" style={{ width: "540px" }}>
          <button
            ...
            aria-label="Close"
            onClick={() => {
              document.querySelector(".popUpItem").classList.remove("open");
            }}
          ></button>
          {details.map((d) => {
            return (
            ...
            >
              ...
              <div className="card-body d-flex flex-wrap align-content-between">
                <div className="d-flex justify-content-between w-100">
                  <h5 className="card-title pb-3 d-inline-block w-100">
                    {product.title}
                  </h5>
                  <button
