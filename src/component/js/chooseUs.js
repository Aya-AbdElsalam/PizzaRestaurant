...
import pizza from "../../images/about04.webp";
import i1 from "../../images/icon01.webp";
import i2 from "../../images/icon02.webp";
import i3 from "../../images/icon03.webp";
import i4 from "../../images/icon04.webp";
      ...
      <div className="container">
        <div className=" row g-2">
          ...
          <div className="chooseUsSectionDiv2 col-md">
            <img src={pizza} alt="" width="60" height="500" className="w-100" />
          </div>
        </div>
      </div>
    </div>
